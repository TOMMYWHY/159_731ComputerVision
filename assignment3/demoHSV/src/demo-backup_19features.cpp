...
//    model = load_classifier<ANN_MLP>("./res/Glass_ann_model.xml");
    ...
    float CE[]  = {
            0,2,0.264634,0.239876,0.140115,0.0766376,0.0653112,0.0432939,0.025703,0.0178403,0.0217669,0.0207387,0.0143877,0.0215421,0.0193005,0.00893385,0.025511,0.0170549,0.0153974,0.0122142,0.00537482,
...
//    Mat sample1 = (Mat_<float>(1,9) << CE[1],CE[2],CE[3],CE[4],CE[5],CE[6],CE[7],CE[8],CE[9]);
    Mat sample1 = (Mat_<float>(1,19) << CE[1],CE[2],CE[3],CE[4],CE[5],CE[6],CE[7],CE[8],CE[9],CE[10],
            CE[11],CE[12],CE[13],CE[14],CE[15]
            ,CE[16],CE[17],CE[18],CE[19]
    );

//    Mat sample1 = (Mat_<float>(1,19) << 2,0.264634,0.239876,0.140115,0.0766376,0.0653112,0.0432939,0.025703,0.0178403,0.0217669,0.0207387,0.0143877,0.0215421,0.0193005,0.00893385,0.025511,0.0170549,0.0153974,0.0122142,0.00537482);
