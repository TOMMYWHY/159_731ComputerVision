...
//    EllipticFourierDescriptors(contours[largestcontour], CE);
    vector<float> CEs=  EllipticFourierDescriptors( contours[largestcontour] );
    return CEs;*/
}
...
//        Mat test_img = imread("./images/test/0_B.jpg",1);//0
//        Mat test_img = imread("./images/test/1_B.jpg",1);//0
//        Mat test_img = imread("./images/test/2_B.jpg",1);//2
//        Mat test_img = imread("./images/test/3_B.jpg",1);//2
//        Mat test_img = imread("./images/test/4_B.jpg",1);//3
//        Mat test_img = imread("./images/test/5_B.jpg",1);//5
//        Mat test_img = imread("./images/test/6_B.jpg",1);//5
//        Mat test_img = imread("./images/test/7_B.jpg",1);//2
//        Mat test_img = imread("./images/test/8_B.jpg",1);//5
//        Mat test_img = imread("./images/test/9_B.jpg",1);//5
